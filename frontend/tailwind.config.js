...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Core palette
        navy:    { DEFAULT: 'var(--color-navy)', 50: '#f0f1f5', 100: '#d1d4e0', 200: '#a3a9c2', 300: '#747ea3', 400: '#465385', 500: '#172866', 600: '#111e4d', 700: '#0c1539', 800: '#070d26', 900: '#030612' },
        ...
        surface: { DEFAULT: 'var(--color-surface)', card: 'var(--color-surface-card)', border: 'var(--color-surface-border)', hover: 'var(--color-surface-hover)' },
